...
- **page-description-audit**: This script runs on a cron schedule using GitHub Actions to review page descriptions, align them to the Microsoft Style Guide, and add any new descriptions where there was none. This is raised in a PR which requires manual review and merge.
